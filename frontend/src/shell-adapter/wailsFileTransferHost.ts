...
export const wailsFileTransferHost: FileTransferHost = {
    ...
    FTUploadDir: (sessionId, localPath, remotePath) => app()!.FTUploadDir(sessionId, localPath, remotePath),
    FTDownloadDir: (sessionId, remotePath, localPath) => app()!.FTDownloadDir(sessionId, remotePath, localPath),
