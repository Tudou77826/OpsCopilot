...
const lightScheme: ITheme = {
    ...
    selectionInactiveBackground: '#dbe6f6',
    scrollbarSliderBackground: '#c9c1ad',
    scrollbarSliderHoverBackground: '#a89f8a',
    scrollbarSliderActiveBackground: '#9a917c',
    overviewRulerBorder: '#cfc7b4',
