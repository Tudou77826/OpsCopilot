...
const BottomBar: React.FC<{ loadVersion?: () => Promise<string>; tips?: string[] }> = ({ loadVersion, tips = BOTTOM_BAR_TIPS }) => {
    ...
    }, [paused, reducedMotion, tips.length]);
    ...
    return (
        <div style={styles.container} data-testid="bottom-bar">
            <div
                ...
                title={tips[tipIndex % tips.length]}
            >
