...
describe('GardenScene', () => {
  ...
  it('点击新株徽标触发已读回调，且不会同时打开详情', () => {
    ...
    fireEvent.click(screen.getByRole('button', { name: /新发现的闪光/ }))
